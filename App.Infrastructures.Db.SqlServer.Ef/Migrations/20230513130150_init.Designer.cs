...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.Bid", b =>
                {
                    ...
                    b.HasIndex(new[] { "ExpertId" }, "IX_Bids_ExpertId");

                    b.HasIndex(new[] { "OrderId" }, "IX_Bids_OrderId");

                    b.HasIndex(new[] { "StatusId" }, "IX_Bids_StatusId");
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.Expert", b =>
                {
                    ...
                    b.HasIndex(new[] { "CityId" }, "IX_Experts_CityId");
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.ExpertService", b =>
                {
                    ...
                    b.HasIndex(new[] { "ExpertId" }, "IX_ExpertServices_ExpertId");

                    b.HasIndex(new[] { "ServiceId" }, "IX_ExpertServices_ServiceId");
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.Service", b =>
                {
                    b.HasOne("App.Domain.Core.Entities.ServiceCategory", "Category")
                        .WithMany("Services")
